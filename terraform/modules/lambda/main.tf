...
# Lambda URIs are "{+lambda}/{+function}" e.g. "cs188/ping".
# We also support path matching at the root e.g. "cs188" but these require definining separate "_root" terraform resources.
