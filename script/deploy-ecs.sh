...
usage="Usage: deploy-ecs.sh [app-web|app-background] [sha]"
...
new_image="101624687637.dkr.ecr.us-west-2.amazonaws.com/cs188:$2"
...
aws ecs update-service --cluster cs188 \
  --no-cli-pager \
  --region "$ecs_region" \
